...
import SendRegistryClient from './SendRegistryClient';
...
export default async function SendRegistry({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <Suspense fallback={
      ...
      <SendRegistryClient registryId={id} />
    </Suspense>
  );
}
